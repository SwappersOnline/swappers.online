defmodule SwappersOnline.Accounts do
  @moduledoc """
  ...
  alias SwappersOnline.Accounts.{User, UserToken, UserNotifier}
  ...
  See `SwappersOnline.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `SwappersOnline.Accounts.User.password_changeset/3` for a list of supported options.
