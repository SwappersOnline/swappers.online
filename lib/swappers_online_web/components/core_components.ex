defmodule SwappersOnlineWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SwappersOnlineWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SwappersOnlineWeb.Gettext, "errors", msg, opts)
    end
  end
